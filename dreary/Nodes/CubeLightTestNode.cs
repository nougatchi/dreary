...
{
    public class CubeLightTestNode : PickableNode, IRenderable
    {
...
";
        ...
        /// </summary>
        /// <returns></returns>
        public static CubeLightTestNode Create()
        {
            ...
            var node = new CubeLightTestNode(new CubeModel(), CubeModel.strPosition, builder);
            node.Initialize();
        ...
        /// </summary>
        private CubeLightTestNode(IBufferSource model, string positionNameInIBufferable, params RenderMethodBuilder[] builders)
